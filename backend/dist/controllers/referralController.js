...
exports.updateWagerAmount = exports.checkDepositBonus = exports.checkWelcomeBonus = exports.getAvailableBonuses = exports.getReferralStats = exports.creditReferralBonus = exports.trackReferral = exports.generateReferralCode = void 0;
...
const creditReferralBonus = async (referredUserId) => {
    try {
...
const getAvailableBonuses = async (req, res) => {
    try {
        const userId = req.userId;
...
const checkWelcomeBonus = async (userId, depositAmount) => {
    try {
        const user = await prisma.user.findUnique({
            where: { id: userId },
...
exports.checkWelcomeBonus = checkWelcomeBonus;
const checkDepositBonus = async (userId, depositAmount) => {
    try {
        const now = new Date();
...
exports.checkDepositBonus = checkDepositBonus;
const updateWagerAmount = async (userId, amount) => {
    try {
...
exports.updateWagerAmount = updateWagerAmount;
