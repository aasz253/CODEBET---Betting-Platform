...
router.post('/cool-down', authenticate, async (req: any, res) => {
  try {
...
router.post('/self-exclusion', authenticate, async (req: any, res) => {
  try {
...
// Dismiss age warning
router.post('/age-warning-dismissed', authenticate, async (req: any, res) => {
  try {
...
router.get('/reality-check', authenticate, async (req: any, res) => {
  try {
    ...
    res.json({
      timePlayed: Math.floor(timePlayed / 60000), // in minutes
